        ...
        : html`
            ...
            >
              ...
              ${compactNukeAlerts.length > 0
                ? html`
                    <div
                      class="bg-gray-800/92 border-t border-white/10 max-h-[4.5rem] overflow-y-auto"
                    >
          ...
          `}
      <div
        class="hidden lg:flex fixed ${diplomacyOnLeft
          ? "left-0"
          : "right-0"} z-[260] w-96 max-w-[calc(100vw-1rem)] flex-col gap-1.5 pointer-events-none"
      ...
      >
        ...
        >
                    ...
                    return html`
                      ...
                      >
                        <div class="flex-1 min-w-0">
                          <div
                            class="text-xs lg:text-sm leading-tight font-bold"
                          >
                            ${this.getEventDescription(event)}
                          </div>
          ...
          <div class="border-t border-white/10">
            <div
              class="px-3 py-1.5 text-[11px] uppercase tracking-wide text-white/55"
            >
              Messages
            </div>
